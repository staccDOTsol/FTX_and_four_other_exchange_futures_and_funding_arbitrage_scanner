...
class binance(Exchange):
    ...
    def fetch_time(self, params={}):
        ...
        method = 'publicGetTime' if (type == 'spot') else 'dapiPublicGetTime'
    ...
    def fetch_markets(self, params={}):
        ...
        method = 'dapiPublicGetExchangeInfo' if (type == 'future') else 'publicGetExchangeInfo'
    ...
    def fetch_balance(self, params={}):
        ...
        if type == 'future':
            ...
            method = self.safe_string(fetchBalanceOptions, 'method', 'dapiPrivateV2GetAccount')
        elif type == 'margin':
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        method = 'publicGetDepth' if market['spot'] else 'dapiPublicGetDepth'
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        method = 'publicGetTicker24hr' if market['spot'] else 'dapiPublicGetTicker24hr'
        response = getattr(self, method)(self.extend(request, params))
    ...
    def fetch_bids_asks(self, symbols=None, params={}):
        ...
        type = self.safe_string(params, 'type', defaultType)
        query = self.omit(params, 'type')
        method = 'publicGetTickerBookTicker' if (type == 'spot') else 'dapiPublicGetTickerBookTicker'
        response = getattr(self, method)(query)
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        method = 'publicGetKlines' if market['spot'] else 'dapiPublicGetKlines'
        response = getattr(self, method)(self.extend(request, params))
        #
        #     [
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        type = self.safe_string(params, 'type', defaultType)
        query = self.omit(params, 'type')
        defaultMethod = 'dapiPublicGetTrades' if (type == 'future') else 'publicGetTrades'
    ...
    def cancel_all_orders(self, symbol=None, params={}):
        ...
        type = self.safe_string(params, 'type', defaultType)
        query = self.omit(params, 'type')
        method = 'privateDeleteOpenOrders' if (type == 'spot') else 'dapiPrivateDeleteAllOpenOrders'
        response = getattr(self, method)(self.extend(request, query))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if (api == 'private') or (api == 'sapi') or (api == 'wapi' and path != 'systemStatus') or (api == 'dapiPrivate') or (api == 'dapiPrivateV2'):
