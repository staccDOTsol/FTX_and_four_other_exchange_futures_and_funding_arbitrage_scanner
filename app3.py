...
def doCalc():
        ...
        for dt in expis:
            if dt != 'PERP':
                try:
                    ...
                    minimum = tempmids['ftx'][coin + '-PERP']
                    
                    maximum = tempmids['ftx'][coin + '-' + dt]
         #           if coin == 'BTC':
         ##               print(arbs[coin][dt])
          #              print(maximum / minimum)
                    thearb = math.fabs((((maximum / minimum)-1)*100)*365*10) #1.1/1.05 = 
                    #print(thearb)
                    #print(expis[dt])
    ...
    if c > 0:
        ...
        print('avg opportunity (over 50%): ' + str(round(avg*1000)/1000))
        print('max opportunity (over 50%): ' + str(round(maxi*1000)/1000))
        print('# opps: ' + str(c1))
